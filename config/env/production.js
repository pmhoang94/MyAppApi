...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      ...
      adapter: 'sails-mongo',
      url:
        'mongodb://pmhoang94:p28m01h94@cluster0-shard-00-00-t1hlx.gcp.mongodb.net:27017,cluster0-shard-00-01-t1hlx.gcp.mongodb.net:27017,cluster0-shard-00-02-t1hlx.gcp.mongodb.net:27017/test?ssl=true&replicaSet=Cluster0-shard-0&authSource=admin&retryWrites=true&w=majority',
      //--------------------------------------------------------------------------
  ...
  models: {
    ...
    dataEncryptionKeys: {
      default: 'DnK353xorM9qFbdbYG/mB6HERdKSOvvR7v0Y0HHyrS8='
    },
